        ...
        enableFollowFiltering: function(){
            ...
            this.connectedWPDataTable.fnSettings().aoDrawCallback.push({
                ...
                fn: function( oSettings ){
                    ...
                    var filteredData = obj.connectedWPDataTable._('tr', {"filter": "applied"});
                    var datepickFormat = obj.connectedWPDataTable.data('description').datepickFormat;
                    var numberFormat = obj.connectedWPDataTable.data('description').number_format;
