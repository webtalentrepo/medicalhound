...
<table id="<?php echo $wpDataTable->getId() ?>" class="<?php echo $wpDataTable->getCSSClasses() ?> wpDataTable" style="<?php echo $wpDataTable->getCSSStyle() ?>" data-description='<?php echo $wpDataTable->getJsonDescription(); ?>' data-wpdatatable_id="<?php echo $wpDataTable->getWpId(); ?>">
    <thead>
	<tr>
	...
	<tr id="table_<?php echo $wpDataTable->getWpId() ?>_row_<?php echo $wdtRowIndex; ?>">
		...
		<td class="<?php echo $dataColumn->getCSSClasses() ?>" style="<?php echo $dataColumn->getCSSStyle();?>"><?php echo $wpDataTable->returnCellValue( $wdtRowDataArr[ $dataColumnHeader ], $dataColumnHeader ); ?></td>
	    <?php } ?>
	</tr>
