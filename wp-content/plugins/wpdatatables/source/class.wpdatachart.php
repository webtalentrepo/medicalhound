...
class WPDataChart {
   ...
   public function shiftStringColumnUp(){
       ...
       // Format axes
        $this->_render_data['axes']['major'] = array(
            ...
            'label' => $this->_render_data['columns'][0]['label']
        );
   ...
   public function loadFromDB(){
       ...
       $this->setShowGrid( $renderData['show_grid'] );
       $this->setShowTitle( $renderData['show_title'] );
       $this->setShowLegend( $renderData['show_legend'] );
       $this->setShowTitle( $renderData['show_title'] );
