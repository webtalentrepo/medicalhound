...
<div class="ult-container <?php echo additonalClassContainer($classes,'container-'.$row["id"],'tbs');?>" id="container-<?php echo $row["id"]; ?>">
<div class="<?php echo $rty; ?>">
<?php } ?>
<?php 
switch($row["type_id"]){
	case '1':
		?>
		<div class="ult-column span12 <?php echo additonalClass($classes,'col-'.$row["id"].'-1');?>" id="<?php echo 'col-'.$row["id"].'-1';?>">
	...
	case '2':
		?>
		<div class="ult-column span3 <?php echo additonalClass($classes,'col-'.$row["id"].'-1');?>" id="<?php echo 'col-'.$row["id"].'-1';?>">
			<div class="colwrapper"><?php if(!ultimate_dynamic_sidebar($ultimateresponsive,'sidebar-'.$row["id"].'-1',$grid_3)){ echo '&nbsp;'; } ?></div>
		</div>
		<div class="ult-column span3 <?php echo additonalClass($classes,'col-'.$row["id"].'-2');?>" id="<?php echo 'col-'.$row["id"].'-2';?>">
			<div class="colwrapper"><?php if(!ultimate_dynamic_sidebar($ultimateresponsive,'sidebar-'.$row["id"].'-2',$grid_3)){ echo '&nbsp;'; } ?></div>
		</div>
		<div class="ult-column span3 <?php echo additonalClass($classes,'col-'.$row["id"].'-3');?>" id="<?php echo 'col-'.$row["id"].'-3';?>">
			<div class="colwrapper"><?php if(!ultimate_dynamic_sidebar($ultimateresponsive,'sidebar-'.$row["id"].'-3',$grid_3)){ echo '&nbsp;'; } ?></div>
		</div>
		<div class="ult-column span3 <?php echo additonalClass($classes,'col-'.$row["id"].'-4');?>" id="<?php echo 'col-'.$row["id"].'-4';?>">
	...
	case '3':
		?>
		<div class="ult-column span4 <?php echo additonalClass($classes,'col-'.$row["id"].'-1');?>" id="<?php echo 'col-'.$row["id"].'-1';?>">
			<div class="colwrapper"><?php if(!ultimate_dynamic_sidebar($ultimateresponsive,'sidebar-'.$row["id"].'-1',$grid_4)){ echo '&nbsp;'; } ?></div>
		</div>
		<div class="ult-column span4 <?php echo additonalClass($classes,'col-'.$row["id"].'-2');?>" id="<?php echo 'col-'.$row["id"].'-2';?>">
			<div class="colwrapper"><?php if(!ultimate_dynamic_sidebar($ultimateresponsive,'sidebar-'.$row["id"].'-2',$grid_4)){ echo '&nbsp;'; } ?></div>
		</div>
		<div class="ult-column span4 <?php echo additonalClass($classes,'col-'.$row["id"].'-3');?>" id="<?php echo 'col-'.$row["id"].'-3';?>">
	...
	case '4':
		?>
		<div class="ult-column span6 <?php echo additonalClass($classes,'col-'.$row["id"].'-1');?>" id="<?php echo 'col-'.$row["id"].'-1';?>">
			<div class="colwrapper"><?php if(!ultimate_dynamic_sidebar($ultimateresponsive,'sidebar-'.$row["id"].'-1',$grid_6)){ echo '&nbsp;'; } ?></div>
		</div>
		<div class="ult-column span6 <?php echo additonalClass($classes,'col-'.$row["id"].'-2');?>" id="<?php echo 'col-'.$row["id"].'-2';?>">
	...
	case '5':
		...
		<div class="ult-column span6 <?php echo additonalClass($classes,'col-'.$row["id"].'-3');?>" id="<?php echo 'col-'.$row["id"].'-3';?>">
	...
	case '8':
		...
		<div class="ult-column span9 <?php echo additonalClass($classes,'col-'.$row["id"].'-2');?>" id="<?php echo 'col-'.$row["id"].'-2';?>">
	...
	case '9':
		?>
		<div class="ult-column span9 <?php echo additonalClass($classes,'col-'.$row["id"].'-1');?>" id="<?php echo 'col-'.$row["id"].'-1';?>">
	...
	case '10':
		...
		<div class="ult-column span8 <?php echo additonalClass($classes,'col-'.$row["id"].'-2');?>" id="<?php echo 'col-'.$row["id"].'-2';?>">
	...
	case '11':
		?>
		<div class="ult-column span8 <?php echo additonalClass($classes,'col-'.$row["id"].'-1');?>" id="<?php echo 'col-'.$row["id"].'-1';?>">
	...
	case '12':
		...
		<div class="row">
			...
			<div class="ult-column span9  <?php echo additonalClass($classes,'col-'.$row["id"].'-5');?>" id="<?php echo 'col-'.$row["id"].'-5';?>">
	...
	case '14':
		...
		<div class="row">
			...
			<div class="ult-column span6  <?php echo additonalClass($classes,'col-'.$row["id"].'-5');?>" id="<?php echo 'col-'.$row["id"].'-5';?>">
	...
	case '17':
		...
		<div class="row">
			...
			<div class="ult-column span9  <?php echo additonalClass($classes,'col-'.$row["id"].'-4');?>" id="<?php echo 'col-'.$row["id"].'-4';?>">
	...
	case '21':
		...
		<div class="row">
			...
			<div class="ult-column span6  <?php echo additonalClass($classes,'col-'.$row["id"].'-4');?>" id="<?php echo 'col-'.$row["id"].'-4';?>">
	...
	case '23':
		...
		<div class="row">
			...
			<div class="ult-column span8  <?php echo additonalClass($classes,'col-'.$row["id"].'-4');?>" id="<?php echo 'col-'.$row["id"].'-4';?>">
	...
	case '29':
		...
		<div class="ult-column span9">
			...
			<div class="ult-column span3 <?php echo additonalClass($classes,'col-'.$row["id"].'-5');?>" id="<?php echo 'col-'.$row["id"].'-5';?>">
	...
	default:
		...
		?>
		<div class="ult-column span<?php echo $column;?> <?php echo additonalClass($classes,'col-'.$row["id"].'-'.$ik);?>" id="<?php echo 'col-'.$row["id"].'-'.$ik;?>">
