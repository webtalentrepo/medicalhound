...
function wp_widget_control( $sidebar_args ) {
    ...
    <div class="widget-top">
        <div class="widget-title-action">
            ...
            <a class="widget-control-edit hide-if-js" href="<?php echo esc_url( add_query_arg( $query_arg ) ); ?>"><span class="edit"><?php _e('Edit', 'ultimatum'); ?></span><span class="add"><?php _e('Add', 'ultimatum'); ?></span></a>
        </div>
        ...
        <form action="" method="post">
            <div class="widget-content">
                ...
                if ( isset($control['callback']) )
                    ...
                    echo "\t\t<p>" . __('There are no options for this widget.', 'ultimatum') . "</p>\n"; ?>
            </div>
            ...
            <div class="widget-control-actions">
                <div class="alignleft">
                    <a class="widget-control-remove" href="#remove"><?php _e('Delete', 'ultimatum'); ?></a> |
                    <a class="widget-control-close" href="#close"><?php _e('Close', 'ultimatum'); ?></a>
                </div>
                <div class="alignright<?php if ( 'noform' === $has_form ) echo ' widget-control-noform'; ?>">
                    <?php submit_button( __( 'Save','ultimatum' ), 'button-primary widget-control-save right', 'savewidget', false, array( 'id' => 'widget-' . esc_attr( $id_format ) . '-savewidget' ) ); ?>
