...
$tbs3col = 'md';
if(!function_exists('additonalClass')) {
    function additonalClass($e, $f)
    {
    }
}
?>
...
switch($row["type_id"]){
	case '1':
		...
		<div class="ult-column col-<?php echo $tbs3col; ?>-12 <?php echo additonalClass($classes,'col-'.$row["id"].'-1');?>" id="<?php echo 'col-'.$row["id"].'-1';?>">
			<div class="colwrapper"><?php ultimate_wp_list_widget_controls('sidebar-'.$row["id"].'-1') ?></div>
		</div>
		<?php
	break;
	case '2':
		...
		<div class="ult-column col-<?php echo $tbs3col; ?>-3 <?php echo additonalClass($classes,'col-'.$row["id"].'-2');?>" id="<?php echo 'col-'.$row["id"].'-2';?>">
			<div class="colwrapper"><?php ultimate_wp_list_widget_controls('sidebar-'.$row["id"].'-2') ?></div>
		</div>
		<div class="ult-column col-<?php echo $tbs3col; ?>-3 <?php echo additonalClass($classes,'col-'.$row["id"].'-3');?>" id="<?php echo 'col-'.$row["id"].'-3';?>">
			<div class="colwrapper"><?php ultimate_wp_list_widget_controls('sidebar-'.$row["id"].'-3') ?></div>
		</div>
		<div class="ult-column col-<?php echo $tbs3col; ?>-3 <?php echo additonalClass($classes,'col-'.$row["id"].'-4');?>" id="<?php echo 'col-'.$row["id"].'-4';?>">
			<div class="colwrapper"><?php ultimate_wp_list_widget_controls('sidebar-'.$row["id"].'-4') ?></div>
		</div>
		<?php
	break;
	case '3':
	...
	case '12':
		...
		<div class="row">
			...
			<div class="ult-column col-<?php echo $tbs3col; ?>-9  <?php echo additonalClass($classes,'col-'.$row["id"].'-5');?>" id="<?php echo 'col-'.$row["id"].'-5';?>">
				<div class="colwrapper"><?php ultimate_wp_list_widget_controls('sidebar-'.$row["id"].'-5') ?></div>
			</div>
		</div>
		</div>
		<?php
	...
	case '17':
		...
		<div class="row">
			...
			<div class="ult-column col-<?php echo $tbs3col; ?>-9  <?php echo additonalClass($classes,'col-'.$row["id"].'-4');?>" id="<?php echo 'col-'.$row["id"].'-4';?>">
				<div class="colwrapper"><?php ultimate_wp_list_widget_controls('sidebar-'.$row["id"].'-4') ?></div>
			</div>
		</div>
		</div>
	...
	case '29':
		...
		<div class="ult-column col-<?php echo $tbs3col; ?>-9">
			...
			<div class="ult-column col-<?php echo $tbs3col; ?>-3 <?php echo additonalClass($classes,'col-'.$row["id"].'-5');?>" id="<?php echo 'col-'.$row["id"].'-5';?>">
				<div class="colwrapper"><?php ultimate_wp_list_widget_controls('sidebar-'.$row["id"].'-5') ?></div>
			</div>
			</div>
		</div>
	...
	default:
		...
		<div class="ult-column col-<?php echo $tbs3col; ?>-<?php echo $column;?> <?php echo additonalClass($classes,'col-'.$row["id"].'-'.$ik);?>" id="<?php echo 'col-'.$row["id"].'-'.$ik;?>">
			<div class="colwrapper"><?php ultimate_wp_list_widget_controls('sidebar-'.$row["id"].'-'.$ik); ?></div>
		</div>
		<?php
		$ik++;
		}
